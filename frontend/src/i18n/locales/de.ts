        ...
        competition: {
            detail: {
                ...
                tabs: {
                    ...
                    previous_competitions: "Zugehörige Wettbewerbe ({{competitionCount}})",
                    previous_competitions_QUALIFICATION: "Regionalwettbewerbe ({{competitionCount}})",
                    previous_competitions_FINAL: "Qualifikationswettbewerbe ({{competitionCount}})",
                },
