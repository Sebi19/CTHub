        ...
        competition: {
            detail: {
                ...
                tabs: {
                    ...
                    previous_competitions: "Related Competitions ({{competitionCount}})",
                    previous_competitions_QUALIFICATION: "Regional Competitions ({{competitionCount}})",
                    previous_competitions_FINAL: "Qualification Competitions ({{competitionCount}})",
                },
