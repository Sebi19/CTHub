package org.fllhub.backend.service;

import org.fllhub.backend.model.Competition;
import org.fllhub.backend.model.Link;
import org.fllhub.backend.model.Nomination;
import org.fllhub.backend.model.Place;
import org.fllhub.backend.model.Season;
import org.fllhub.backend.model.SeasonTeam;
import org.fllhub.backend.model.RobotGameResult;
import org.fllhub.backend.repository.CompetitionRepository;
import org.fllhub.backend.repository.NominationRepository;
import org.fllhub.backend.repository.PlaceRepository;
import org.fllhub.backend.repository.RobotGameResultRepository;
import org.fllhub.backend.repository.SeasonRepository;
import org.fllhub.backend.repository.SeasonTeamRepository;
...
public class FllScraperService {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(FllScraperService.class);
    ...
    public FllScraperService(SeasonRepository seasonRepository, CompetitionRepository competitionRepository, SeasonTeamRepository seasonTeamRepository, RobotGameResultRepository robotGameResultRepository, PlaceRepository placeRepository, NominationRepository nominationRepository) {
